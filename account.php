...
<div class="content">
	...
	<aside id="default-sidebar" class="full-height top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
		...
		<aside class="ligth-frame">
			<?php
				$buttons = array(
					'user_data'   => 'Mes données',
					'user_books'  => 'Mes livres',
					'user_wishlist' => 'Ma wishlist',
					'user_circles'  => 'Mon cercle',
				);
				...
				foreach ( $buttons as $choice => $text ) {
					...
					// Affichage du bouton
					$isSelected = $active_tab == $choice;
					echo "<a href='?tab=$choice' class='not-default btn-secondary " . ( $isSelected ? '' : 'btn-disabled' ) . "'>$text</a>";
				}
				?>
		</aside>
