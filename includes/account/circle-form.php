...
<ul role="list" class="divide-y divide-gray-100">
	...
	<?php 
	if (sizeof($circles) != 0) {
		echo '<h1 class="pt-4 pb-4 inline-block mb-2 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white dark:text-white" id="content">Mes abonnements</h1>';
	}
	?>
