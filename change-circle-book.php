...
// Redirect user if circle_id or book_id is not given, or if user is not connected, or if he's not the circle's admin.
$is_circle_admin = Database::user_is_circle_admin($user_id, $circle_id);
if($circle_id === null || $user_id === null || $book_id === null || ! $is_circle_admin ) {
