				...
				<div class="grid grid-cols-2 md:grid-cols-3 gap-4">
					<?php foreach ( $books as $book ) : ?>
						<div>
							...
							<h3 class="mt-2 text-xl font-semibold text-gray-800 dark:text-gray-200"><?php echo $book->get_title(); ?></h3>
							<span class="mt-1 text-gray-600 dark:text-gray-400"><?php echo $book->get_author(); ?></span>
